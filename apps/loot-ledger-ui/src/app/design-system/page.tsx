...
export default function DesignSystemPage() {
  ...
  const [comboboxSingle, setComboboxSingle] = useState('');
  const [comboboxMulti, setComboboxMulti] = useState('react,nextjs');

  const comboboxOptions = [
    { value: 'react', label: 'React', group: 'Frontend' },
    { value: 'nextjs', label: 'Next.js', group: 'Framework' },
    { value: 'vue', label: 'Vue', group: 'Frontend' },
    { value: 'nuxt', label: 'Nuxt.js', group: 'Framework' },
  ...
  return (
    ...
    >
      ...
      <DashboardHeader
        ...
        title="Evokit Design System Showcase"
      />
          ...
          <Section id="Guia" title="Guia de Uso" index={1}>
            <div className="space-y-10">
              <div className="border border-border p-6 space-y-3">
                <p className="text-xs font-bold uppercase tracking-widest text-primary font-header">
                  O que é este Design System?
                </p>
                <p className="text-sm text-muted-foreground leading-relaxed max-w-2xl">
                  Um conjunto de tokens de design, componentes React e
                  diretrizes visuais prontos para uso. Tudo é construído sobre
                  variáveis CSS (tokens) que controlam cores, espaçamentos e
                  tipografia de forma centralizada.
                </p>
                <div className="flex flex-wrap gap-2 pt-1">
                  {[
                    ...
                    <span
                      key={t}
                      className="text-[10px] font-semibold uppercase tracking-widest px-2.5 py-1 bg-primary/10 text-primary border border-primary/20 font-header"
                    >
                      {t}
                    </span>
                  ))}
              ...
              <div>
                <p className="text-xs font-bold uppercase tracking-widest text-foreground mb-4 font-header">
                  Tokens de design
                </p>
                  ...
                  <table className="w-full text-xs">
                    <thead>
                      <tr className="border-b border-border bg-secondary/50">
                        {['Token CSS', 'Classe Tailwind', 'Uso'].map((h) => (
                          <th
                            key={h}
                            className="text-left px-4 py-2.5 text-[9px] uppercase tracking-widest text-muted-foreground font-mono"
                          >
                            {h}
                          </th>
                        ))}
                    ...
                    <tbody className="divide-y divide-border/50">
                      {[
                        ...
                        >
                          <td className="px-4 py-2.5 text-primary font-mono">
                            {token}
                          </td>
                          <td className="px-4 py-2.5 text-foreground/70 font-mono">
                            {cls}
                          </td>
          ...
          <Section id="Typography" title="Typography" index={3}>
            <div className="space-y-5">
              {[
                {
                  tag: 'Display',
                  cls: 'text-5xl font-bold uppercase tracking-tight font-header',
                  sample: 'Display Heading',
                },
                {
                  tag: 'H1',
                  cls: 'text-4xl font-bold uppercase tracking-wide font-header',
                  sample: 'Heading Level One',
                },
                {
                  tag: 'H2',
                  cls: 'text-3xl font-semibold uppercase tracking-wide font-header',
                  sample: 'Heading Level Two',
                },
                {
                  tag: 'Body',
                  cls: 'text-base font-base',
                  sample:
                    'Body text — clear, readable, measured. Designed for sustained reading with Inter.',
                },
                {
                  tag: 'Small',
                  cls: 'small-text text-muted-foreground',
                  sample:
                    'Small text — micro copy, labels, legal text, and secondary details.',
                },
                {
                  tag: 'Mono',
                  cls: 'text-sm text-primary font-mono',
                  sample: '--primary: oklch(0.87 0.21 128.1);',
                },
              ].map(({ tag, cls, sample }) => (
                <div
                  key={tag}
                  className="flex gap-4 items-baseline border-b border-border/50 pb-4"
                >
                  <span className="text-[9px] text-muted-foreground w-14 shrink-0 uppercase tracking-widest font-mono">
                    {tag}
                  </span>
          ...
          <Section id="Buttons" title="Buttons" index={5}>
            <div className="space-y-6">
              ...
              <div className="p-6 border border-border bg-card/20 flex flex-wrap gap-4 items-end">
                ...
                <Btn size="icon" aria-label="Settings">
                  <Zap size={14} />
                </Btn>
              </div>
              <div className="p-6 border border-border bg-card/20 flex flex-wrap gap-4">
                ...
                <Btn disabled icon={<Shield size={14} />}>
                  Disabled
                </Btn>
              </div>
              <Code
          ...
          <Section id="Links" title="Links & Anchors" index={6}>
            <div className="space-y-6">
              <div className="p-6 border border-border bg-card/20 flex flex-wrap gap-4 items-center">
                <LinkBtn href="#Links" external>
                  External link button
                </LinkBtn>
                <div className="text-sm">
                  Please read the{' '}
                  <TextLink href="#Links" external>
                    documentation
                  </TextLink>{' '}
                  for more details.
                </div>
            ...
            <div className="space-y-6">
              <div className="p-6 border border-border bg-card/20 grid sm:grid-cols-2 gap-4">
                ...
                <InputField
                  ...
                  helper="Required for newsletter"
                />
                <InputField
                  label="Password"
                  type="password"
          ...
          <Section id="Cards" title="Cards" index={10}>
            <div className="space-y-6">
              <div className="grid sm:grid-cols-3 gap-4">
                <Card>
                  <p className="text-[9px] text-muted-foreground uppercase tracking-widest font-mono mb-2">
                    Monthly Revenue
                  </p>
                  <p className="text-3xl font-bold font-header">$42,190</p>
                </Card>
                <Card className="hover:border-primary/45 transition-colors">
                  <p className="text-[9px] text-primary uppercase tracking-widest font-mono mb-2">
                    Active Users
                  </p>
            ...
            <div className="space-y-6">
              <div className="space-y-3">
                <Alert
                  variant="info"
                  title="Info"
                  message="Your plan renews on July 1, 2026."
                />
                <Alert
                  variant="success"
                  title="Success"
                  message="Figma token library synced successfully."
                />
                <Alert
                  variant="warning"
                  title="Warning"
                  message="You have used 82% of your monthly API quota."
                />
                <Alert
                  variant="danger"
                  title="Danger"
          ...
          <Section id="Dropdown" title="Dropdown Menu" index={15}>
            <div className="space-y-6">
              <div className="p-6 border border-border bg-card/20">
                <Dropdown
                  trigger={
                    <button className="px-4 py-2 border border-border bg-secondary hover:bg-secondary/80 text-xs font-bold font-mono tracking-widest uppercase cursor-pointer text-foreground">
                      Menu de Exemplo
                    </button>
                  }
                  align="left"
                >
                  ...
                  <DropdownDivider />
                  <DropdownItem danger>Sair</DropdownItem>
                </Dropdown>
              </div>
              <Code
                tabs={{
                  usage: `import { Dropdown, DropdownItem, DropdownLabel, DropdownDivider } from "@core/evokit";

<Dropdown
  trigger={
    <button className="px-4 py-2 border border-border bg-secondary text-xs uppercase">
      Menu de Exemplo
    </button>
  }
  align="left"
...
// Dropdown is self-contained. Renders Profile, Settings, Notifications, a divider, and Sign Out actions.`,
          ...
          <Section id="Modal" title="Modal Dialog" index={16}>
            <div className="space-y-6">
              <div className="p-6 border border-border bg-card/20 flex justify-center">
                <Btn onClick={() => setIsDemoModalOpen(true)}>
                ...
                {isDemoModalOpen && (
                  <Modal
                    ...
                    title="Modal de Teste do EvoKit"
                  >
                    <div className="space-y-4 font-space-grotesk text-xs text-foreground">
                      <p>Este é um exemplo de diálogo modal renderizado pelo sistema.</p>
                      <p>Ele escuta a tecla ESC e cliques fora da janela para fechar automaticamente.</p>
                      <div className="flex justify-end gap-2 mt-4">
                        <Btn variant="outline" onClick={() => setIsDemoModalOpen(false)}>
                          Cancelar
                        </Btn>
                        <Btn onClick={() => setIsDemoModalOpen(false)}>
                          Confirmar
                        </Btn>
                      </div>
                    </div>
...
import { Modal, Button } from "@core/evokit";
...
interface ModalProps {
  ...
  onClose: () => void;    // Callback fired when overlay click or escape key is pressed.
  ...
  unit?: string; // suffix for displayed value (e.g. '%', 'px')
          ...
          <Section id="Toggle" title="Toggle Switches" index={20}>
            <div className="space-y-6">
              ...
              <Code
                tabs={{
                  usage: `import { Toggle } from "@core/evokit";

<Toggle label="Modo escuro"          defaultChecked={true} />
<Toggle label="Notificações por email" defaultChecked={false} />`,
                  api: `// Component parameters (props)
            ...
            <div className="space-y-6">
              <div className="p-6 border border-border bg-card/20 flex flex-col md:flex-row items-center justify-around gap-6">
                ...
                <div className="flex flex-col gap-2">
                  <span className="text-xs text-muted-foreground uppercase tracking-widest font-mono text-center">
                    Interactive Control
                  </span>
                  <div className="flex gap-2">
                    <Btn
                      size="sm"
                      onClick={() =>
                        setCircleVal((prev) => Math.max(0, prev - 10))
                      }
                    >
                      -10%
                    </Btn>
                    <Btn
                      size="sm"
                      onClick={() =>
                        setCircleVal((prev) => Math.min(100, prev + 10))
                      }
                    >
                      +10%
                    </Btn>
              ...
              >
                <div className="space-y-6">
                  <p className="text-muted-foreground leading-relaxed">
                    This drawer panel slides in from the screen side
                    (customizable to left or right). It locks scroll on the
                    parent body, responds to Escape key presses, and is fully
                    styled with high-contrast borders and a blurred backdrop.
                  </p>
                  ...
                  <div className="space-y-4 pt-4 border-t border-border">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-[10px] uppercase font-bold text-[var(--status-success)] px-1.5 py-0.5 bg-[var(--status-success-bg)] border border-[var(--status-success-border)]">
                          ENABLED
                        </span>
                      </div>
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-[10px] uppercase font-bold text-muted-foreground px-1.5 py-0.5 bg-secondary border border-border">
                          STAGING
                        </span>
                      </div>
                    </div>
